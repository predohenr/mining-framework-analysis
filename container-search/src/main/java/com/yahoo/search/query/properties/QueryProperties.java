...
public class QueryProperties extends Properties {
    ...
    private static Map<CompoundName, GetterSetter> createPropertySetterMap() {
        ...
        addDualCasedRM(map, Matching.FILTER_FIRST_THRESHOLD, GetterSetter.of(query -> query.getRanking().getMatching().getFilterFirstThreshold(), (query, value) -> query.getRanking().getMatching().setFilterFirstThreshold(asDouble(value, 0.3))));
